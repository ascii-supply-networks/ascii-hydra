...
class Step_1(SparkScriptPipes):
    def execute_business_logic(  # noqa: C901
        ...
        csv_file_path = os.path.join(local_data_path, "amazon_review_full_csv", "train.csv")
        ...
        word_count_df.write.mode("overwrite").parquet(f"s3a://{output_bucket_name}/{output_key}")
