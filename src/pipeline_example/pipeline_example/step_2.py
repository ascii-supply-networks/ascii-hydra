...
class Step_2(SparkScriptPipes):
    def execute_business_logic(  # noqa: C901
        ...
        avg_word_length_df = word_count_df.withColumn("word_length", length(word_count_df.word))
        avg_length_df = avg_word_length_df.agg(avg("word_length").alias("avg_word_length"))
        avg_length_df.show()
