...
from ascii_library.orchestration.pipes import Engine
...
step1 = spark_pipes_asset_factory(
    ...
    databricks_cluster_config={
        ...
        # TODO experiment with instance selection!
        # m7gd.2xlarge might be cheaper - but graviton seems to often time run out / be overused
...
cc_landingpage = define_asset_job(
    "cc_landingpage",
    selection=[step1],
)
